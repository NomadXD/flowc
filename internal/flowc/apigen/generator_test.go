...
func TestGenerate_HasAllSchemas(t *testing.T) {
	...
	expected := []string{
		...
		"EnvironmentSpec", "EnvironmentStatus",
		...
		"GatewayResponse", "ListenerResponse", "EnvironmentResponse", "APIResponse", "DeploymentResponse",
		"GatewayListResponse", "ListenerListResponse", "EnvironmentListResponse", "APIListResponse", "DeploymentListResponse",
		"GatewayPutRequest", "ListenerPutRequest", "EnvironmentPutRequest", "APIPutRequest", "DeploymentPutRequest",
